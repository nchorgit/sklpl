$(document).ready(function() {
  ...
  var number_of_items = $(".lprod").load("/experts/testexp.html").find('li').length;
  ...
  $(".lprod").load("/experts/testexp.html").find("li").css('display', 'none');
  $(".lprod").load("/experts/testexp.html").find("li").slice(0, show_per_page).css('display', 'block');
  ...
  $('.lprod').find("li").css('display', 'none').slice(start_from, end_on).css('display', 'block');
