$(document).ready(function() {
    ...
    var number_of_items = $('.lprod').find('.product-url').length;
    ...
    $('.lprod').find(".product-url").css('display', 'none');
    $('.lprod').find(".product-url").slice(0, show_per_page).css('display', 'block');
    ...
    $('.lprod').find(".product-url").css('display', 'none').slice(start_from, end_on).css('display', 'block');
